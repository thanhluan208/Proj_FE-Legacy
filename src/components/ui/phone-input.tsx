		...
		return (
			<div className={inputClasses}>
				...
				<input
					...
					name="phone"
					className={cn(
						"flex w-full border-none bg-transparent text-base transition-colors placeholder:text-muted-foreground outline-none h-9 py-1 px-0 leading-none md:text-sm [interpolate-size:allow-keywords]",
						className
					)}
					{...props}
				/>
